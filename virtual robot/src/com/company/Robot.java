...
public class Robot {
    ...
    public void update(){
        ...
        worldXPosition += 1.2*totalSpeed * Math.cos(outputAngle) * elapsedTime * 1000 * 0.2;
        worldYPosition += 1.2*totalSpeed * Math.sin(outputAngle) * elapsedTime * 1000 * 0.2;

        worldAngle_rad += 1.2*MovementVars.movement_turn * elapsedTime * 20 / (2 * Math.PI);
